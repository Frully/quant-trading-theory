...
- 提出者：Andrew Lo (MIT)
- 详见：[第二十章：市场结构演化](20_market_structure_evolution.md)

### APT (Arbitrage Pricing Theory)
套利定价理论。资产收益由多个因子的风险敞口决定，是多因子模型的理论基础。
- 详见：[第十三章：因子定价](13_factor_pricing.md)
...
自动做市商。使用数学公式（如恒定乘积公式 $x \times y = k$）而非订单簿来定价的去中心化交易机制。
...
- 详见：[第十四章：市场微观结构](14_market_microstructure.md)

### Black-Scholes-Merton Model
BSM模型。期权定价的经典模型，假设标的资产服从几何布朗运动。
- 详见：[第十五章：衍生品定价](15_derivatives_pricing.md)
...
- 详见：[第十九章：市场生态](19_market_ecosystem.md)

### CVaR / ES (Expected Shortfall)
条件风险价值 / 预期损失。超过 VaR 时的平均损失，比 VaR 更关注尾部风险。
- 详见：[第十七章：风险理论](17_risk_theory.md)
...
### Funding Rate
资金费率。永续合约中多空双方定期支付的费用，用于锚定永续价格与现货价格。
- 详见：[第十二章：加密货币市场](12_cryptocurrency_markets.md)
...
- 详见：[第十八章：交易执行](18_trade_execution.md)
...
- 详见：[第十六章：投资组合理论](16_portfolio_theory.md)
...
最大可提取价值。区块生产者通过重新排序、插入或审查交易而获取的价值，包括抢跑、三明治攻击等。
- 详见：[第十二章：加密货币市场](12_cryptocurrency_markets.md)
...
### Perpetual Swap
永续合约。没有到期日的期货合约，通过资金费率机制使价格锚定现货，是加密货币市场的独特发明。
- 详见：[第十二章：加密货币市场](12_cryptocurrency_markets.md)
...
| 12 | 加密货币市场 | Perpetual Swap, AMM, MEV, Funding Rate |
| 13 | 因子定价 | CAPM, APT, Beta |
| 14 | 市场微观结构 | Liquidity, Bid-Ask Spread, HFT |
| 15 | 衍生品定价 | BSM, Greeks, Implied Volatility |
| 16 | 投资组合理论 | MPT, Risk Parity, Kelly |
| 17 | 风险理论 | VaR, CVaR, Fat Tails |
| 18 | 交易执行 | Market Impact, TCA, TWAP/VWAP |
| 19 | 市场生态 | Crowding, Liquidity |
| 20 | 市场结构演化 | AMH |

...
金字塔加仓本质上是**趋势跟踪策略的仓位管理组件**。两者共享同一个核心假设：**趋势会延续**。

| 层次 | 解决的问题 | 方法 |
|-----|-----------|------|
| **信号层**（趋势跟踪） | 做多还是做空？ | 突破、均线交叉等 |
| **仓位层**（金字塔） | 下多大的注？ | 盈利时加仓 |
...
趋势跟踪的核心理念是"截断亏损，让利润奔跑"。金字塔加仓是这一理念的直接体现：

- **趋势判断错误时**（价格反向）→ 只有初始小仓位 → 亏损有限
- **趋势判断正确时**（价格延续）→ 逐步加大仓位 → 利润放大

如果没有金字塔加仓，趋势跟踪策略会面临一个尴尬：
- 初始仓位小 → 即使趋势正确，收益也有限
- 初始仓位大 → 判断错误时，亏损也大

金字塔加仓解决了这个两难：**小仓试探，确认后加码**。

详见 [趋势跟踪策略](04_trend_following.md)。
...
**配套策略**：
- [趋势跟踪策略](04_trend_following.md) — 金字塔的主要应用场景，信号层 + 仓位层的完整体系

**交易系统设计**：
- [加密货币金字塔趋势跟踪系统](../systems/crypto_pyramid_trend.md) — 完整的可执行交易系统，结合趋势跟踪与金字塔加仓
...
- [网格交易策略](03_grid_trading.md) — 区间策略，与趋势跟踪相反
